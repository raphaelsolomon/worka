...
class AndroidPlanPrice extends StatefulWidget {
  const AndroidPlanPrice({Key? key}) : super(key: key);

  @override
  State<AndroidPlanPrice> createState() => _AndroidPlanPriceState();
}

class _AndroidPlanPriceState extends State<AndroidPlanPrice> {
  String reference = '';
        ...
        children: [
          ...
          Visibility(
              ...
              child: selectButton(context, '${plan_price['plan']}',
                  '${plan_price['price']}', plan_price['details']))
        ],
      ),
    );
  }
  ...
  selectButton(
          BuildContext context, String plan, String price, ProductDetails ID) =>
      GestureDetector(
        onTap: () async {
          this.plan = plan;
