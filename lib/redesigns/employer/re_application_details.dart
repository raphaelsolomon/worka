...
class ReApplicationDetails extends StatefulWidget {
  ...
  final String jobKey;
  const ReApplicationDetails(this.application, this.jobKey, {super.key});
...
class _ReApplicationDetailsState extends State<ReApplicationDetails> {
  ...
  void initState() {
    context
        .read<EmpController>()
        .viewApplicationList(context, widget.application.applicant!.uid)
        .then((value) => setState(() {
              viewAppModel = value;
              isLoading = false;
            }));
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      backgroundImage: NetworkImage(
                                          '${widget.application.applicant!.displayPicture}'),
                                    ),
                                    const SizedBox(
                                      width: 25.0,
                                    ),
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          '${widget.application.applicant!.firstName} ${widget.application.applicant!.lastName}',
