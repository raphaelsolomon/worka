...
class ReApplicantCompanyProfile extends StatefulWidget {
  final Map<String, String> data;
  const ReApplicantCompanyProfile(this.data, {super.key});

  @override
  State<ReApplicantCompanyProfile> createState() =>
      _ReApplicantCompanyProfileState();
}

class _ReApplicantCompanyProfileState extends State<ReApplicantCompanyProfile> {
  bool isJobDesc = true;
...
Widget getAboutCompany(CompModel compModel) =>
    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text('https://www.google.com',
          style: GoogleFonts.lato(fontSize: 13.0, color: DEFAULT_COLOR)),
      const SizedBox(
        height: 18.0,
      ),
      ...
      Container(
          ...
          decoration: BoxDecoration(
              color: Color(0xFFE7EAFB).withOpacity(.5),
              borderRadius: BorderRadius.circular(5.0),
              border: Border.all(width: .5, color: Color(0xFF00D0BC))),
          child: Text('20 Hires',
              style: GoogleFonts.lato(fontSize: 15.0, color: DEFAULT_COLOR, fontWeight: FontWeight.w600))),
      const SizedBox(
        height: 18.0,
      ),
    ]);
